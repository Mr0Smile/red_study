...
import zjnu.red_study.service.GoodsService;
...
public class GoodsController {
    ...
    public Result cancelOrtder(@RequestParam Integer goods_id,@RequestParam Integer num) {
        Goods goods = goodsService.selectById(goods_id);
        System.out.println("present stock: " + goods.getStock() + num);
