      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="图片" prop="img">
          <template #default="scope">
            <el-image style="border-radius: 5%; max-width: 50px; "
                      :src="scope.row.img"
    ...
    <el-dialog title="书籍信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="简介" prop="descr">
          <el-input v-model="data.form.descr" autocomplete="off" type="textarea" />
        </el-form-item>
        ...
        <el-form-item label="分类" prop="category_id">
          <el-select v-model="data.form.category_id" placeholder="请选择分类" style="width: 60%">
            <el-option
