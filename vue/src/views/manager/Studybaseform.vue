  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table :data="data.tableData" stripe>
        <el-table-column label="名称" prop="studyBaseformName"></el-table-column>
        <el-table-column label="简介" prop="descr"></el-table-column>
        <el-table-column label="操作" header-align="center" width="300">
          <template #default="scope">
            <el-button type="primary" @click="gotoArticle(scope.row.articleId)">前往文章</el-button>
    ...
    >
      ...
      >
        <el-form-item label="名称" prop="studyBaseformName">
          <el-input v-model="data.form.studyBaseformName" autocomplete="off" />
        </el-form-item>
