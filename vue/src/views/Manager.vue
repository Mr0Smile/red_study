    ...
    <div style="height: 60px; background-color: #fff; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          ...
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px">红色研学系统</div>
        </div>
      </div>
...
<!--          <el-menu-item index="/buy">-->
          <el-menu-item index="/buy" v-if="data.user.role === 'USER'">
            ...
            <span>购买</span>
          </el-menu-item>   <el-menu-item index="/orders">
            <el-icon><Tickets /></el-icon>
            <span v-if="data.user.role === 'USER'">购物车</span>
