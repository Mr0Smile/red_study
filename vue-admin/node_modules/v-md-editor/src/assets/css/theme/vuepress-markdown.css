.vuepress-markdown-body code[class*='v-md-hljs-'],
.vuepress-markdown-body pre[class*='v-md-hljs-'] {
  color: #ccc;
  font-size: 1em;
...
.vuepress-markdown-body :not(pre) > code[class*='v-md-hljs-'],
.vuepress-markdown-body pre[class*='v-md-hljs-'] {
  background: #2d2d2d;
}
.vuepress-markdown-body :not(pre) > code[class*='v-md-hljs-'] {
...
.vuepress-markdown-body pre[class*='v-md-hljs-'] code,
...
.vuepress-markdown-body div[class*='v-md-pre-wrapper-'] pre[class*='v-md-hljs-'] {
  position: relative;
  z-index: 1;
...
.vuepress-markdown-body div[class~='v-md-pre-wrapper-cpp']::before {
  content: 'cpp';
}
...
.v-md-editor__main .vuepress-markdown-body:not(.custom) {
  padding: 15px 15px;
}
...
.vuepress-markdown-body .hljs-comment,
.vuepress-markdown-body .hljs-quote,
.vuepress-markdown-body .hljs-variable {
  color: #008000;
}
.vuepress-markdown-body .hljs-keyword,
.vuepress-markdown-body .hljs-selector-tag,
.vuepress-markdown-body .hljs-name,
.vuepress-markdown-body .hljs-tag {
  /*color: #00f;*/
  color: #0031AB;
}
.vuepress-markdown-body .hljs-string,
.vuepress-markdown-body .hljs-section,
.vuepress-markdown-body .hljs-attribute,
.vuepress-markdown-body .hljs-literal,
.vuepress-markdown-body .hljs-template-tag,
.vuepress-markdown-body .hljs-template-variable,
.vuepress-markdown-body .hljs-addition {
  color: #a31515;

}
.vuepress-markdown-body .hljs-built_in {
  color: #0031AB;
  font-weight: bold;
  /*font-style: italic;*/
}
.vuepress-markdown-body .hljs-title {
  color: #b18e29;
  font-weight: bold;
}
.vuepress-markdown-body .hljs-number {
  color: #4750ee;
}
.vuepress-markdown-body .hljs-type {
  color: #00f;
}
.vuepress-markdown-body .hljs-deletion,
.vuepress-markdown-body .hljs-selector-attr,
.vuepress-markdown-body .hljs-selector-pseudo,
.vuepress-markdown-body .hljs-meta {
  color: #2b91af;
}
.vuepress-markdown-body .hljs-doctag {
  color: #808080;
}
.vuepress-markdown-body .hljs-attr {
  color: #f00;
}
.vuepress-markdown-body .hljs-symbol,
.vuepress-markdown-body .hljs-bullet,
.vuepress-markdown-body .hljs-link {
  color: #00b0e8;
}
.vuepress-markdown-body .hljs-emphasis {
  font-style: italic;
}
.vuepress-markdown-body .hljs-strong {
  font-weight: bold;
}
