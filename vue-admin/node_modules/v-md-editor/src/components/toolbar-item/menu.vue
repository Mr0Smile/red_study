<template>
  <transition name="v-md-zoom-in-top">
    ...
    >
      ...
      <template v-else-if="isRenderMode">
        <expand
          :style="{
            width: menus[0].width || 'auto',
            height: menus[0].height || 'auto',
            minHeight: menus[0].minHeight || 'auto',
            minWidth: menus[0].minWidth || 'auto',
          }"
          :hide="hide"
          :render="menus[0].render"
        ></expand>
      </template>
      <template v-else>
        <li>
